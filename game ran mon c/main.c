...
void information(){
	...
	SetColor(4);
	gotoxy(10,8);
	printf("Moi gop y vui long gui ve hom thu phamtuananh2101@gmail.com");
		gotoxy(8,9);
		printf("hoac lien he fb: https://www.facebook.com/tuan.anh30/");
		gotoxy(3,10);
		printf("Chuc ae hoc tap hieu qua, an phim bat ki de tro lai menu");
		gotoxy(27,11);
		SetColor(14);
		printf("----Tuan Anh----");
		getchar();
...
void menu(){
	...
	system("cls");
    gotoxy(25,3);
	printf("Game ran an moi cua tuan anh");
	gotoxy(30,5);
	SetColor(4);
	printf("1. Vao game");
	gotoxy(30,6);
